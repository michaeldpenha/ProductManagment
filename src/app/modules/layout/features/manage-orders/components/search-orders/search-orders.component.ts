...
export class SearchOrdersComponent implements OnInit {
  ...
  public initializeForm = () => {
    this.formFields = [
      new FormFieldConfig({ type: 'input', subtype: 'number', min : 0, formName: 'orderId',  placeholder: StaticText.orderIdPlaceHolder, fieldWidthCls: 'col-md-2', fieldWidth: 'col-md-12', displayLabelCls: 'form-group required row', fieldLabelClass: 'col-md-3 col-form-label', inputClass: "form-control form-control-sm" }),
      new FormFieldConfig({ type: 'input', subtype: 'number', min:0,formName: 'itemId', placeholder: StaticText.itemNumber, fieldWidthCls: 'col-md-2', fieldWidth: 'col-md-12', displayLabelCls: 'form-group required row', fieldLabelClass: 'col-md-3 col-form-label', inputClass: "form-control form-control-sm" }),
      new FormFieldConfig({ type: 'input', formName: 'customerGroupId', placeholder: StaticText.customerId, fieldWidthCls: 'col-md-2', fieldWidth: 'col-md-12', displayLabelCls: 'form-group required row', fieldLabelClass: 'col-md-3 col-form-label', inputClass: "form-control form-control-sm" }),
      new FormFieldConfig({
      ...
      new FormFieldConfig({ type: 'input', min : 0, subtype: 'number',formName: 'supplierId', placeholder: StaticText.supplier, fieldWidthCls: 'col-md-2', fieldWidth: 'col-md-12', displayLabelCls: 'form-group required row', fieldLabelClass: 'col-md-3 col-form-label', inputClass: "form-control form-control-sm" }),
      new FormFieldConfig({
